...
[![Agent Status](https://img.shields.io/badge/Status-Operational-brightgreen.svg)](https://github.com/YourUsername/TizianGPT)
...
Tizian is built around the LangChain framework and operates using the **Tool-Augmented Generation** pattern:

1.  **LLM Core (Tizian):** The AI (powered by OpenAI/WormGPT) acts as the strategist, deciding *what* attack to perform.
...
## ⚙️ 🛠️ Getting Started (The Deployment Guide)

### Prerequisites
*   Python 3.9+
*   OpenAI API Key (Required for the base model)
